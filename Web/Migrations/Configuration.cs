    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Web.Models.TutorialAppContext>
    {
        ...
        protected override void Seed(Web.Models.TutorialAppContext context)
        {
            ...
            context.Cities.AddOrUpdate(p => p.Name,
                new Models.City { Name = "İstanbul" },
                new Models.City { Name = "Ankara" },
                new Models.City { Name = "İzmir" }
            );
            ...
            context.Districts.AddOrUpdate(p => p.Name,
                new Models.District { Name = "Pendik", CityId = context.Cities.FirstOrDefault(c => c.Name == "İstanbul").Id },
                new Models.District { Name = "Kartal", CityId = context.Cities.FirstOrDefault(c => c.Name == "İstanbul").Id },
                new Models.District { Name = "Sancaktepe", CityId = context.Cities.FirstOrDefault(c => c.Name == "İstanbul").Id },
                ...
                new Models.District { Name = "Alsancak", CityId = context.Cities.FirstOrDefault(c => c.Name == "İzmir").Id },
                new Models.District { Name = "Seferihisar", CityId = context.Cities.FirstOrDefault(c => c.Name == "İzmir").Id }
            );
        }
